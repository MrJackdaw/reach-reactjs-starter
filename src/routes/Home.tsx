import { ExLink, Section, PageContainer } from "components/Common/Containers";
  ...
  <Wrapper className="Home" padded>
    ...
    <Section>
      ...
      <p>
        ...
        styles (global or local), rename component files, and/or re-arrange
      ...
      <p>
        ...
        properties, or create as many unique state instances, as you like.
      </p>
      <p>
        There is a{" "}
        <a
        ...
        that uses it in <code>src/hooks/useGlobalUser.ts</code>. You can use
        that to create and share reusable hooks between components.
      </p>
    ...
    <Section>
      ...
      <p>
        ...
        . You can use it to create reusable styled containers for your app. It
        also makes global app themes (<i>light</i> and <i>dark</i> mode) much
        easier, if you want them.
      </p>
      <hr />
      ...
      <p>
        ...
        write your global styles in <code>src/App.scss</code>. You might also
        want to look at <code>src/theme/theme.shared.ts</code> to make sure
        there are no other globals overriding your hard work.
      </p>
      <hr />
      ...
      <ol>
        <li>
          Define the colors for your <b>Light</b> and <b>Dark</b> themes in{" "}
          <code>src/theme/</code>. There is a file for each theme.
        </li>

        <li>
          Import and link the <code>setTheme</code> function in{" "}
          <code>src/theme/index.ts</code> to a UI component. When the component
          is triggered (e.g. clicked), you can call the function with the
          corresponding value (<code>Dark</code> or <code>Light</code>) and the
          UI will update.
        </li>
      </ol>
